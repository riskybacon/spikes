 ...
 */
void FontTextureOSX::setText(const std::string& text)
{
 ...
 * Set alignment
 */
void FontTextureOSX::setAlign(TextAlign align)
{
   switch(align)
   {
 ...
 */
void FontTextureOSX::setForegroundColor(const glm::vec4& fgColor)
{
   CGFloat colorDst[4];
 ...
 */
void FontTextureOSX::setFont(const std::string& fontNameSrc, float pointSize)
{
 ...
 */
void FontTextureOSX::createContext()
{
   if(_ctx != NULL)
   {
