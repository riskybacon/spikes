...
namespace GL
{
   ...
   /**
    * Constructor. Creates a shader program that consists of a vertex and 
    * fragment shader. After construction, this program becomes the 
    * currently active GL program
    *
    * @param vShaderFile
    *    Name of the file that contains the vertex shader
    * @param fShaderFile
    *    Name of the file that contains the fragment shader
    */
   ...
   /**
    * Constructor. Creates a shader program that consists of a vertex, fragment
    * and geometry shader. After construction, this program becomes the 
    * currently active GL program
    *
    * @param vShaderFile
    *    Name of the file that contains the vertex shader
    ...
    *    Name of the file that contains the fragment shader
    * @param gShaderFile
    *    Name of the file that contains the geometry shader
    */
   Program::Program(const std::string& vShaderFile, const std::string& fShaderFile,
