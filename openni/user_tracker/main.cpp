...
void glutKeyboard (unsigned char key, int x, int y)
{
	...
	case 'b':
		// Draw background?
         g_bDrawBackground = !g_bDrawBackground; // no
		break;
	case 'x':
		// Draw pixels at all?
         g_bDrawPixels = !g_bDrawPixels; // yes
		break;
	case 's':
		// Draw Skeleton?
         g_bDrawSkeleton = !g_bDrawSkeleton; // yes
		break;
	case 'i':
		// Print label?
         g_bPrintID = !g_bPrintID; // no
		break;
	case 'l':
...
int main(int argc, char **argv)
{
	...
	else
	{
		...
		nRetVal = g_Context.InitFromXmlFile(CONFIG_FILE, g_scriptNode, &errors);
